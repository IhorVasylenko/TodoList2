...
// thanks
export const fetchTask = (todoListId: string): ThunkType => async (dispatch: ThunkDispatchType) => {
    try {
...
export const removeTask = (id: string, todoListId: string): ThunkType => async (dispatch: ThunkDispatchType) => {
    try {
        dispatch(actionsForApp.setAppStatus("loading"));
        dispatch(actionsForTasks.updateTaskEntityStatus(todoListId, id, "loading"));
        let res = await todoListAPI.removeTask(todoListId, id);
...
export const createTask = (todoListId: string, title: string): ThunkType => async (dispatch: ThunkDispatchType) => {
    try {
        dispatch(actionsForApp.setAppStatus("loading"));
