...
beforeEach (() => {
    startState = {
        "todolistId1": [
            { tasksId: "1", title: "CSS", isDone: false },
            { tasksId: "2", title: "JS", isDone: true },
            { tasksId: "3", title: "React", isDone: false }
        ],
        "todolistId2": [
            { tasksId: "1", title: "bread", isDone: false },
            { tasksId: "2", title: "milk", isDone: true },
            { tasksId: "3", title: "tea", isDone: false }
        ]
    }
})
